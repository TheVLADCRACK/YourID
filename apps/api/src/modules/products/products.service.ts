...
export class ProductsService {
  ...
  async create(storeId: string, dto: CreateProductDto) {
    ...
    // Cast some fields to any to satisfy Prisma generated enum/JSON typings
  ...
  async update(id: string, storeId: string, dto: UpdateProductDto) {
    ...
    // Cast update payload to any to avoid strict Prisma input mismatches
    return this.prisma.product.update({
      where: { id: product.id },
      data: { ...(dto as any), updatedAt: new Date() } as any,
